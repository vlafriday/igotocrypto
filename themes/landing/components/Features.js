                ...
                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <LazyImage src='https://newsbit.nl/app/uploads/2023/07/prijs-stijgt-scaled.webp'/> {/* тут ссылка на картинки */}
                    </div>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                        <LazyImage src='https://isternet.com/cdn/images/2022/04/22/09/53c1ed87e7564006d684819cb8bc3d20.jpg'/>
                    </div>
                  </Transition>
                  {/* Item 3 */}
                  <Transition
