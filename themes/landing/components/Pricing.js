...
export const Pricing = (props) => {
  ...
  <div className="w-full mx-auto bg-white dark:bg-black px-5 py-10 text-gray-800 mb-10">
    ...
    <div className="max-w-4xl mx-auto md:flex">
        ...
        <div className="w-full md:w-1/3 md:max-w-none bg-white dark:bg-hexo-black-gray px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 rounded-md shadow-lg shadow-gray-600 md:relative md:z-20 md:flex md:flex-col">
            <div className="w-full flex-grow dark:text-gray-400">
