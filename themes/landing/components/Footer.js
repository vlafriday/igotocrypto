            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                     ...
                     {/*    <h6 className="text-gray-800 font-medium mb-2">Инвестируй</h6> */}
                        <ul className="text-sm">
                            <li className="mb-2">
                                 <a  className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"> </a>
                            </li>
                            <li className="mb-2">
                ...
                <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
                    ...
                    <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                      ...
                      <li className="ml-4">
                        <a href="https://www.t.me/igotocrypto" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out" aria-label="Telegram">
                          <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="500" height="500" viewBox="0 0 50 50">
