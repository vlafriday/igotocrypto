          ...
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded-md shadow-xl border">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><a href="https://www.youtube.com/@igotocrypto" target="_blank" rel="noopener noreferrer"></a>{siteConfig('LANDING_FEATURES_BLOCK_1_TITLE', null, CONFIG)}</h4>
