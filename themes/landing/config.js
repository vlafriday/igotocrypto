const CONFIG = {
  ...
  LANDING_TESTIMONIALS_P: 'Вообще, я очень много даю бесплатных, но при это колосально полезных материалов (потому что я ими сам пользуюсь).<br/>Но если ты хочешь пойти за белым кроликом и глуже окунуться в кроличью нору, то пора освободить твой разум.<br/>Но я могу лишь указать дверь.<br/>Ты сам должен выйти на волю..<br/>Действия за тобой.',
