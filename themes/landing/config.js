const CONFIG = {
  ...
  LANDING_TESTIMONIALS_P: 'Вообще, я очень много даю бесплатных, но при это колосально полезных материалов (потому что я ими сам пользуюсь). \n Но если ты хочешь пойти за белым кроликом и глуже окунуться в кроличью нору, то пора освободить твой разум. Но я могу лишь указать дверь. Ты сам должен выйти на волю.. <br/> Действия за тобой.',
