const CONFIG = {
  ...
  LANDING_TESTIMONIALS_P: 'Вообще, я очень много даю бесплатных, но при это колосально полезных материалов (потому что я ими сам пользуюсь), но если ты хочешь пойти за белым кроликом и глуже окунуться в кроличью нору, то предложения ниже. Призывать не буду, выбор твой.',
