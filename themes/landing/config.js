const CONFIG = {
  ...
  LANDING_FEATURES_CARD_1_TITLE: 'Трейдинг',
  LANDING_FEATURES_CARD_1_P: 'Что это такое? Откуда там деньги? И самый главный вопрос: как там зарабатывать?',
  LANDING_FEATURES_CARD_2_TITLE: 'IDO, ICO, инвестиции',
  LANDING_FEATURES_CARD_2_P: 'Где покупать монеты до того, как они выходят на биржу, чтобы продать дороже?',
  LANDING_FEATURES_CARD_3_TITLE: 'Сколько можно заработать на криптовалюте?',
  LANDING_FEATURES_CARD_3_P: 'Всё зависит от способа заработка и вложений в него, времени, которое у тебя есть и ты готов его тратить.',
  ...
  LANDING_PRICING_P: 'Примешь синюю таблетку — и сказке конец.<br/>Ты проснешься в своей постели и поверишь, что это был сон.<br/>Примешь красную таблетку — войдешь в страну чудес.<br/>Я покажу тебе, глубока ли кроличья нора.',
