const CONFIG = {
  ...
  LANDING_TESTIMONIALS_P: 'Вообще, я очень много даю бесплатных, но при это колосально полезных материалов (потому что я ими сам пользуюсь). <br/> Пора освободить твой разум. <br/> Но я могу лишь указать дверь. <br/> Ты сам должен выйти на волю.',
