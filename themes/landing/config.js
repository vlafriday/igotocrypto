const CONFIG = {
  ...
  LANDING_FEATURES_HEADER_2_P: 'Криптовалюты – это не просто деньги и технологии – это возможность войти туда, где все только развивается, и вырасти вместе с этим рынком. Изучать крипту сейчас – это как забронировать место в первых рядах на шоу будущего.',
  ...
  LANDING_FEATURES_CARD_2_P: 'Можно торговать, инвестировать в новые проекты, заниматься майнингом или стейкингом, чтобы получать пассивный доход. Найти свою нишу.',
  ...
  LANDING_TESTIMONIALS_P: 'Я очень много даю бесплатных, но при это колосально полезных материалов<br/>(потому что я ими сам пользуюсь).<br/>Но если ты хочешь пойти за белым кроликом,<br/>глуже окунуться в кроличью нору,<br/>то пора освободить твой разум.<br/>Но я могу лишь указать дверь.<br/>Ты сам должен выйти на волю..',
  ...
  LANDING_PRICING_P: "<strong class='font-bold text-blue-500'>Примешь синюю таблетку</strong> — и сказке конец.<br/>Ты проснешься в своей постели и поверишь, что это был сон.<br/> <strong class='font-bold text-red-500'>Примешь красную таблетку</strong> — войдешь в страну чудес.<br/>Я покажу тебе, глубока ли кроличья нора.<br/> ",
