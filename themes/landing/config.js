const CONFIG = {
  ...
  LANDING_FEATURES_CARD_2_P: 'Можно торговать, инвестировать в новые проекты, заниматься майнингом или стейкингом, чтобы получать пассивный доход. Это шанс найти свою нишу в мире инноваций и получать прибыль, отходя от обычных методов.',
  LANDING_FEATURES_CARD_3_TITLE: 'Сколько можно заработать на криптовалюте?',
  LANDING_FEATURES_CARD_3_P: 'Всё зависит от способа заработка и вложений в него, времени, которое у тебя есть и ты готов его вкладывать.',
