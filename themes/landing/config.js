const CONFIG = {
  ...
  LANDING_FEATURES_HEADER_2_P: 'Крипта – твой билет в будущее: зарабатывай, расти вместе с рынком. Занимай лучшие места в финансовой революции. Начни сегодня, чтобы создать свое завтра!',
  ...
  LANDING_FEATURES_BLOCK_1_P: 'Заработок на покупке и продаже из-за изменений цены монет',
  LANDING_FEATURES_BLOCK_2_TITLE: 'Скальпинг',
  LANDING_FEATURES_BLOCK_2_P: 'Что это такое и как заработать на быстрых сделках',
  LANDING_FEATURES_BLOCK_3_TITLE: 'IDO и ICO',
  LANDING_FEATURES_BLOCK_3_P: 'Как купить монеты раньше других и продать с прибылью',
  LANDING_FEATURES_BLOCK_4_TITLE: 'Лаунчпады и лаунчпулы',
  LANDING_FEATURES_BLOCK_4_P: 'Что такое лаунчпады, лаунчпулы и как на этом заработать',
  LANDING_FEATURES_BLOCK_5_TITLE: 'Инвестирование',
  LANDING_FEATURES_BLOCK_5_P: 'Долгосрочное инвестирование и создание криптопортфеля',
  LANDING_FEATURES_BLOCK_6_TITLE: 'Airdrop. P2E',
  LANDING_FEATURES_BLOCK_6_P: 'Другие интересные виды заработка на крипте',
