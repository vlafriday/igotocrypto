const CONFIG = {
  ...
  LANDING_FEATURES_HEADER_2_P: 'Криптовалюты – это входной билет в новый финансовый мир, где каждый может заработать и узнать о новых технологиях. Это не просто деньги и технологии – это возможность войти туда, где все только развивается, и вырасти вместе с этим рынком. Изучать крипту сейчас – это как забронировать место в первых рядах на шоу будущего.',
