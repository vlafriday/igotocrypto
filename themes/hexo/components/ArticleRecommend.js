                  ...
                  return (
                    (<Link
                            ...
                            <div className="h-full w-full relative group">
                                ...
                                <LazyImage src={headerImage} className='shadow-2xl absolute top-0 w-full h-full object-cover object-center group-hover:scale-110 group-hover:brightness-50 transform duration-200' />
                            </div>
