...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'landing', // Текущая тема, все поддерживаемые темы можно найти в папке тем; например, именем темы является имя папки. example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/+bpgBpFSD4R03OTIy', // 你的telegram 地址 例如 https://t.me/tangly_1024
  //CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://www.linkedin.com/in/igotocrypto/', // 你的linkedIn 首页
